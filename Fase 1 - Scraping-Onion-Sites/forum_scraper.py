        ...
        records.append(
            {
                ...
                "huella_contenido": content_fingerprint,
                "id_hilo": thread_id,
                "id_mensaje_padre": parent_message_id,
                "usuario": username,
...
def build_http_client(network_mode: str):
    ...
    if network_mode == "whonix":
        ...
        session.proxies = {
            "http": "socks5h://10.152.152.10:9050",
            "https": "socks5h://10.152.152.10:9050",
        }
        return session
...
def main() -> None:
    ...
    parser.add_argument("--csv-out", default="../Datos/forum_records.csv")
    ...
    while pending:
        ...
        # Guardar número de registros extraídos en esta página en el reporte
        save_incremental_keyword_report({"REGISTROS_PAGINA": len(unique_page_records)}, args.report_out, current_url)
